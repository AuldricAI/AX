    ...
    if (isSignedIn) {
        return (
            <div className="flex flex-col min-h-[560px] w-[420px] bg-slate-950 items-center justify-center p-8 text-white">
                ...
                <h1 className="text-xl font-semibold mb-3 text-center">Successfully Signed In!</h1>
                <p className="text-sm text-slate-400 text-center max-w-[280px]">
                    You can now safely close this tab and return to the AX extension to start using the awesome features.
                </p>
